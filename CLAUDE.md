...
7. `docs/especificacao/prompt-claude-code-onda1.md`, `prompt-claude-code-onda2.md`, `prompt-claude-code-onda3.md`, `prompt-claude-code-onda4.md`, `prompt-claude-code-onda5.md` e `prompt-claude-code-onda6.md` — arquitetura, stack, fluxos, fases e critérios de aceite de cada onda.
8. `docs/especificacao/prompt-dossie-due-diligence.md` — template versionado do dossiê de due diligence (F8).
9. `docs/referencias/Plataforma_Broto_-_Prototipo_v8.1_FINAL.html` — especificação visual vigente (protótipo unificado das seis ondas, T1–T28). Reproduzir layout, tokens e microinterações. Onde o prompt da Onda 3 cita "protótipo v4.1" e o da Onda 4 cita "v7.1" na seção de telas, leia-se **v8.1 FINAL**: é a versão vigente e contém as T15–T17 e as T26–T28. `docs/referencias/ficha-m1-viasat.html` é a referência visual do formulário M1 da Ficha Cadastral. As versões `v7.1`, `v6.1` e `v2.1` do protótipo permanecem apenas como histórico (respectivamente das ondas 1–5, das ondas 1–3/5 e da Onda 1).
...
- **Trabalho fase a fase** (F1→F5 do prompt da Onda 1; F6→F9 do prompt da Onda 2; F10 do prompt da Onda 3; F11 do prompt da Onda 5; F12 do prompt da Onda 4; F13 do prompt da Onda 6, **última do escopo especificado**). Concluir a fase, commitar, abrir PR com resumo e **parar no checkpoint** para revisão humana. Não avançar de fase sem aprovação explícita. Fases de ondas distintas podem correr em trilhas paralelas; a coordenação é sempre pela main. A F13 tem pré-requisito total — o Dashboard colhe de todas as ondas, então exige F1–F12 na main.
