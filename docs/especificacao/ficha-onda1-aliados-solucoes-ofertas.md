...
| Imagem do card | imagem | ●² | |
| Link externo | URL | ○ | |
| Status | ativa / inativa | ● | Inativar solução pausa suas ofertas publicadas (RN04) |

² Obrigatório para publicar oferta desta solução (RN09).
...
| Preço de / preço por | moeda / moeda | condicional | Exigido conforme o tipo; Recompensa exige valor zero; Cupom exige desconto definido. **Não se aplica ao tipo Percentual de desconto** (ver linha abaixo) |
| Percentual de desconto | inteiro 1–100 | condicional | Tipo de benefício = Percentual de desconto. **Substitui preço de/por**: some o preço, fica só o %. Errata de 24/08 — o campo não existia; ofertas Percentual anteriores permanecem com preço de/por e este vazio, sem recálculo. Card exibe "X% de desconto" |
...
9. **RN09** — Régua de completude: publicar oferta exige o conjunto mínimo do card (nome de exibição e logo do aliado; nome, descrição curta, categoria, culturas, cobertura e imagem da solução).
