...
**[A CONFIRMAR]**: ~~política de retenção da auditoria (jurídico)~~ — **RESPONDIDA em 21/09: integral, com gatilho medido (ver RN49)**; eventual priorização/corte de indicadores do Dashboard por você — como todos vêm de fichas já validadas, o conjunto acima segue como aprovado salvo corte explícito.
